...
CREATE TABLE City (
  ...
  PRIMARY KEY (ID),
  CHECK (Population >= 0)                                 -- Population non-negative
...
CREATE TABLE Country (
  ...
  CHECK (SurfaceArea >= 0),                                -- SurfaceArea non-negative
  CHECK (Population >= 0),                                 -- Population non-negative
  CHECK (GNP >= 0),                                        -- GNP non-negative
  CHECK (GNPOld >= 0)                                      -- GNPOld non-negative
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE CountryLanguage (
  ...
  CHECK (Percentage >= 0 AND Percentage <= 100) -- Constraint for Percentage
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE CountryPrices (
    CountryCode CHAR(3) NOT NULL DEFAULT '',
    MilkCheeseEggsPrice DECIMAL(10, 2) NOT NULL,
    MilkCheeseEggsGlobalRank INT NOT NULL,
    MeatPrice DECIMAL(10, 2),
    MeatGlobalRank INT NOT NULL,
	FruitPrice DECIMAL(10, 2),
    FruitGlobalRank INT NOT NULL,
	FishSeafoodPrice DECIMAL(10, 2),
    FishSeafoodGlobalRank INT NOT NULL,
    PRIMARY KEY (CountryCode),
	CHECK (MilkCheeseEggsPrice >= 0),
    CHECK (MeatPrice >= 0),
    CHECK (FruitPrice >= 0),
    CHECK (FishSeafoodPrice >= 0)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


START TRANSACTION;
INSERT INTO CountryPrices (
    CountryCode, 
    MilkCheeseEggsPrice, MilkCheeseEggsGlobalRank, 
    MeatPrice, MeatGlobalRank, 
    FruitPrice, FruitGlobalRank,
    FishSeafoodPrice, FishSeafoodGlobalRank
) 
VALUES
('ALB', 87.03, 137, 83.05, 103, 82.59, 117, 111.37, 68),
('DZA', 73.09, 158, 121.76, 31, 82.09, 119, 140.53, 35),
('AGO', 186.75, 10, 128.18, 26, 141.80, 36, 185.81, 5),
('ATG', 188.47, 8, 112.49, 44, 339.87, 1, 139.36, 38),
('ARG', 142.74, 35, 84.52, 100, 139.56, 38, 162.49, 16),
('ARM', 90.58, 129, 86.96, 94, 92.45, 94, 80.74, 123),
('ABW', 153.35, 24, 108.58, 51, 174.70, 12, 146.45, 30),
('AUS', 144.57, 34, 140.67, 18, 146.44, 28, 163.18, 13),
('AUT', 104.69, 92, 179.24, 7, 153.60, 23, 192.78, 2),
('AZE', 70.22, 160, 58.45, 158, 58.45, 145, 70.25, 149),
('BHS', 204.57, 4, 99.92, 68, 268.52, 4, 101.47, 89),
('BHR', 104.67, 94, 108.77, 50, 150.81, 25, 75.68, 132),
('BGD', 93.78, 124, 85.14, 98, 88.45, 104, 73.52, 142),
('BRB', 146.90, 28, 155.65, 11, 305.29, 3, 155.37, 22),
('BLR', 65.82, 164, 66.37, 147, 82.97, 116, 74.08, 139),
('BEL', 107.31, 87, 154.94, 12, 146.40, 29, 159.72, 20),
('BLZ', 114.47, 73, 99.87, 69, 72.60, 127, 121.98, 54),
('BEN', 145.57, 32, 67.34, 141, 59.99, 144, 73.70, 140),
('BMU', 192.98, 6, 107.14, 53, 165.41, 15, 137.92, 41),
('BTN', 82.44, 147, 63.87, 153, 86.07, 109, 61.96, 158),
('BOL', 70.83, 159, 52.87, 164, 60.00, 143, 77.02, 128),
('BIH', 80.38, 150, 84.28, 101, 95.91, 87, 108.36, 77),
('BWA', 111.15, 78, 72.68, 126, 89.96, 100, 143.97, 32),
('BRA', 121.49, 63, 76.08, 118, 105.73, 76, 108.41, 76),
('BRN', 121.49, 64, 98.83, 71, 143.05, 35, 81.58, 120),
('BGR', 93.51, 126, 78.04, 115, 84.78, 112, 105.69, 81),
('BFA', 132.78, 47, 68.99, 135, 47.83, 164, 96.49, 99),
('MMR', 86.10, 141, 67.00, 142, 67.91, 136, 56.02, 163),
('BDI', 129.85, 52, 70.13, 132, 52.26, 158, 162.16, 17),
('CAF', 197.98, 5, 87.44, 92, 60.20, 142, 108.85, 74),
('KHM', 102.91, 99, 89.68, 86, 87.59, 105, 70.33, 148),
('CMR', 139.99, 37, 67.69, 140, 60.76, 141, 73.65, 141),
('CAN', 152.46, 25, 136.14, 21, 148.05, 27, 141.48, 34),
('CPV', 88.63, 135, 85.77, 97, 143.10, 34, 98.57, 96),
('TCD', 121.42, 65, 56.38, 161, 69.43, 131, 100.08, 92),
('CHL', 137.71, 42, 113.90, 40, 83.17, 115, 116.69, 61),
('CHN', 149.34, 26, 98.55, 72, 143.34, 33, 116.05, 62),
('COL', 96.94, 113, 81.74, 106, 69.20, 133, 131.31, 48),
('COM', 171.94, 15, 102.47, 63, 69.17, 134, 115.80, 63),
('CRI', 134.49, 44, 108.90, 49, 132.22, 44, 162.94, 14),
('HRV', 94.89, 119, 105.15, 57, 110.52, 68, 136.85, 43),
('CYP', 138.43, 40, 115.02, 37, 116.36, 60, 149.92, 26),
('CZE', 85.81, 142, 90.96, 83, 99.06, 81, 133.75, 45),
('COD', 145.85, 31, 90.89, 84, 51.50, 160, 104.49, 82),
('DNK', 114.51, 72, 150.13, 15, 135.34, 41, 190.29, 3),
('DJI', 165.63, 18, 104.52, 58, 113.82, 62, 120.18, 55),
('DOM', 117.01, 68, 76.00, 120, 105.11, 77, 106.77, 78),
('DMA', 146.87, 29, 109.26, 48, 178.15, 9, 103.27, 84),
('ECU', 110.77, 79, 95.55, 75, 76.37, 126, 122.39, 53),
('EGY', 60.89, 166, 70.06, 133, 41.99, 165, 48.85, 166),
('SLV', 100.25, 104, 81.42, 108, 69.43, 132, 80.23, 124),
('GNQ', 127.79, 57, 89.32, 87, 109.24, 72, 84.28, 118),
('EST', 99.17, 106, 102.36, 64, 115.28, 61, 139.99, 36),
('ETH', 134.49, 45, 98.91, 70, 88.66, 102, 87.96, 111),
('FJI', 146.29, 30, 100.44, 66, 112.57, 65, 86.38, 115),
('FIN', 112.18, 76, 148.46, 16, 145.78, 30, 162.57, 15),
('FRA', 97.30, 111, 160.40, 10, 162.59, 18, 166.30, 10),
('GNB', 122.16, 61, 80.38, 112, 85.08, 110, 68.26, 152),
('GAB', 121.26, 66, 112.34, 46, 112.03, 66, 98.56, 97),
('GMB', 108.03, 83, 74.51, 124, 64.80, 138, 50.41, 165),
('GEO', 104.68, 93, 75.34, 123, 92.45, 94, 142.87, 33),
('DEU', 90.25, 131, 129.24, 25, 122.35, 57, 182.79, 6),
('GHA', 154.70, 22, 72.01, 129, 53.44, 157, 96.28, 101),
('GRC', 131.34, 49, 114.22, 39, 86.15, 108, 158.22, 21),
('GRD', 170.66, 16, 114.36, 38, 174.98, 11, 124.39, 52),
('GIN', 133.28, 46, 66.40, 146, 71.19, 129, 78.80, 126),
('GUY', 139.91, 38, 106.00, 55, 131.56, 45, 76.89, 130),
('HTI', 148.93, 27, 90.13, 85, 71.43, 128, 133.58, 46),
('HND', 94.06, 122, 76.02, 119, 77.48, 125, 96.34, 100),
('HKG', 187.16, 9, 137.27, 20, 169.65, 14, 165.49, 11),
('HUN', 90.56, 130, 92.78, 80, 99.81, 80, 138.21, 40),
('ISL', 167.47, 17, 216.64, 3, 156.44, 21, 175.01, 8),
('IND', 68.69, 162, 65.43, 148, 58.15, 146, 62.36, 157),
('IDN', 106.59, 89, 78.54, 113, 107.68, 75, 71.09, 146),
('IRN', 79.23, 152, 106.80, 54, 138.13, 39, 98.04, 98),
('IRQ', 95.62, 117, 103.03, 60, 98.92, 82, 68.13, 153),
('IRL', 121.71, 62, 134.46, 22, 158.01, 20, 162.06, 18),
('ISR', 192.16, 7, 181.60, 6, 129.37, 51, 178.90, 7),
('ITA', 113.15, 75, 146.18, 17, 134.54, 42, 152.39, 25),
('CIV', 140.94, 36, 84.59, 99, 56.68, 150, 90.59, 107),
('JAM', 172.92, 14, 97.09, 74, 130.86, 46, 103.35, 83),
('JPN', 173.59, 12, 198.56, 4, 254.45, 5, 144.62, 31),
('JOR', 107.83, 85, 113.53, 41, 118.06, 59, 99.29, 94),
('KAZ', 76.71, 153, 66.78, 145, 96.55, 86, 75.66, 133),
('KEN', 98.70, 107, 72.52, 127, 64.79, 139, 110.25, 70),
('KWT', 111.68, 77, 118.18, 34, 198.11, 7, 95.97, 102),
('KGZ', 75.58, 157, 63.91, 152, 84.57, 113, 81.47, 121),
('LAO', 106.33, 90, 80.95, 110, 83.91, 114, 76.24, 131),
('LVA', 101.68, 101, 91.93, 81, 110.55, 67, 126.77, 50),
('LSO', 95.14, 118, 67.84, 139, 88.64, 103, 75.23, 136),
('LBR', 213.25, 2, 92.84, 79, 95.90, 88, 56.65, 162),
('LTU', 86.58, 139, 86.85, 95, 95.48, 89, 108.61, 75),
('LUX', 127.61, 58, 171.63, 8, 164.46, 16, 165.33, 12),
('MDG', 88.58, 136, 55.97, 162, 56.39, 151, 89.29, 109),
('MWI', 97.85, 108, 57.17, 159, 49.04, 162, 87.59, 113),
('MYS', 92.02, 128, 68.92, 136, 87.40, 106, 74.10, 138),
('MDV', 126.78, 59, 73.57, 125, 144.22, 32, 45.00, 167),
('MLI', 137.34, 43, 63.14, 155, 56.31, 152, 65.93, 155),
('MLT', 113.54, 74, 119.32, 33, 133.06, 43, 155.32, 23),
('MRT', 103.70, 98, 70.44, 131, 96.57, 85, 71.62, 145),
('MUS', 101.07, 102, 126.62, 28, 109.61, 70, 102.83, 85),
('MEX', 79.38, 151, 80.62, 111, 80.82, 120, 109.41, 72),
('MDA', 75.84, 155, 69.50, 134, 89.46, 101, 77.60, 127),
('MNG', 92.27, 127, 45.72, 167, 125.91, 53, 110.47, 69),
('MNE', 83.13, 146, 78.27, 114, 102.31, 78, 119.59, 58),
('MSR', 209.46, 3, 125.30, 30, 336.08, 2, 188.15, 4),
('MAR', 84.77, 144, 105.89, 56, 92.23, 95, 85.91, 116),
('MOZ', 107.89, 84, 83.04, 104, 69.89, 130, 74.73, 137),
('NAM', 117.62, 67, 88.92, 90, 122.05, 58, 55.68, 164),
('NPL', 75.83, 156, 72.13, 128, 68.45, 135, 79.54, 125),
('NLD', 97.42, 109, 151.27, 14, 123.88, 55, 147.01, 28),
('NZL', 161.52, 20, 163.59, 9, 152.59, 24, 147.01, 29),
('NIC', 81.71, 149, 65.30, 149, 55.01, 153, 87.17, 114),
('NER', 138.38, 41, 82.03, 105, 66.33, 137, 118.30, 59),
('NGA', 86.59, 138, 62.43, 156, 54.37, 155, 72.17, 143),
('MKD', 69.97, 161, 75.88, 122, 53.94, 156, 91.86, 105),
('NOR', 173.17, 13, 196.65, 5, 160.63, 19, 161.19, 19),
('OMN', 93.99, 123, 107.68, 52, 124.23, 54, 69.13, 150),
('PAK', 97.13, 112, 63.39, 154, 98.18, 84, 67.05, 154),
('PAN', 131.18, 50, 88.78, 91, 109.46, 71, 112.35, 66),
('PRY', 85.73, 143, 57.03, 160, 82.52, 118, 102.31, 87),
('PER', 114.76, 70, 83.38, 102, 92.01, 96, 115.74, 64),
('PHL', 108.05, 82, 66.79, 144, 90.86, 97, 58.39, 161),
('POL', 67.68, 163, 75.91, 121, 79.49, 122, 99.47, 93),
('PRT', 107.55, 86, 104.09, 59, 112.79, 63, 138.66, 39),
('QAT', 107.29, 88, 121.34, 32, 144.99, 31, 106.10, 79),
('COG', 126.63, 60, 100.55, 65, 93.57, 91, 111.93, 67),
('ROU', 89.28, 133, 76.68, 117, 60.88, 140, 100.84, 91),
('RUS', 89.16, 134, 87.12, 93, 84.83, 111, 84.74, 117),
('RWA', 129.70, 53, 47.04, 166, 56.78, 148, 110.23, 71),
('STP', 144.81, 33, 127.71, 27, 86.43, 107, 114.16, 65),
('LCA', 176.40, 11, 138.68, 19, 149.21, 26, 75.24, 135),
('SAU', 97.34, 110, 102.99, 61, 140.45, 37, 87.65, 112),
('SEN', 128.49, 56, 77.17, 116, 90.72, 98, 71.64, 144),
('SRB', 84.31, 145, 81.34, 109, 92.82, 93, 120.18, 56),
('SYC', 129.12, 54, 112.35, 45, 129.52, 50, 102.61, 86),
('SLE', 94.58, 120, 64.49, 151, 47.89, 163, 61.90, 159),
('SGP', 132.77, 48, 129.36, 24, 127.87, 52, 137.51, 42),
('SVK', 96.52, 115, 94.78, 76, 108.00, 74, 153.75, 24),
('SVN', 100.05, 105, 113.25, 42, 108.74, 73, 129.93, 49),
('ZAF', 104.26, 95, 89.21, 88, 92.89, 92, 91.14, 106),
('ESP', 93.74, 125, 109.39, 47, 130.00, 47, 125.40, 51),
('LKA', 94.28, 121, 100.37, 67, 98.52, 83, 61.32, 160),
('VCT', 154.20, 23, 93.11, 78, 163.31, 17, 91.89, 104),
('SDN', 76.54, 154, 59.78, 157, 90.68, 99, 75.34, 134),
('SUR', 95.64, 116, 94.58, 77, 109.83, 69, 64.69, 156),
('SWZ', 104.11, 97, 81.66, 107, 78.27, 124, 102.11, 88),
('SWE', 115.63, 69, 154.35, 13, 155.56, 22, 170.89, 9),
('CHE', 138.91, 39, 295.27, 2, 178.15, 10, 229.13, 1),
('TWN', 130.98, 51, 113.11, 43, 129.75, 49, 120.14, 57),
('TJK', 82.02, 148, 70.49, 130, 80.29, 121, 92.92, 103),
('TZA', 101.97, 100, 47.91, 165, 50.57, 161, 76.96, 129),
('THA', 100.38, 103, 68.61, 138, 100.40, 79, 68.97, 151),
('TGO', 114.52, 71, 89.16, 89, 54.46, 154, 106.09, 80),
('TTO', 158.98, 21, 117.41, 35, 180.71, 8, 99.05, 95),
('TUN', 55.91, 167, 85.82, 96, 57.55, 147, 80.97, 122),
('TUR', 104.21, 96, 102.81, 62, 95.20, 90, 139.64, 37),
('ARE', 128.89, 55, 131.52, 23, 169.88, 13, 109.36, 73),
('GBR', 90.21, 132, 116.88, 36, 123.78, 56, 117.04, 60),
('USA', 109.91, 80, 125.64, 29, 136.28, 40, 147.33, 27),
('UGA', 86.43, 140, 66.95, 143, 51.92, 159, 132.71, 47),
('UKR', 62.54, 165, 54.19, 163, 60.88, 140, 89.10, 110),
('URY', 162.19, 19, 98.55, 73, 129.96, 48, 101.06, 90),
('VNM', 96.54, 114, 68.79, 137, 79.31, 123, 70.63, 147),
('ZMB', 106.19, 91, 65.24, 150, 56.77, 149, 90.10, 108),
('ZWE', 109.44, 81, 90.99, 82, 112.78, 64, 83.02, 119);
COMMIT;

-- CountryCrime table

DROP TABLE IF EXISTS CountryCrime;
CREATE TABLE CountryCrime (
    CountryCode CHAR(3) NOT NULL,
    KidnappingRate DECIMAL(5, 1) NOT NULL,
    KidnappingGlobalRank INT NOT NULL,
    RobberyRate INT NOT NULL,
    RobberyGlobalRank INT NOT NULL,
    HomicideRate DECIMAL(5, 1),
    HomicideGlobalRank INT,
    PRIMARY KEY (CountryCode)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

START TRANSACTION;
INSERT INTO CountryCrime (CountryCode, KidnappingRate, KidnappingGlobalRank, RobberyRate, RobberyGlobalRank, HomicideRate, HomicideGlobalRank) 
VALUES
('BEL', 10.3, 1, 167, 11, 1.7, 52),
('CAN', 10.3, 2, 62, 26, 1.8, 51),
('ZAF', 9.6, 3, 332, 6, 35.9, 5),
('PAK', 8.8, 4, 6, 70, 4.2, 40),
('NZL', 7.9, 5, 78, 24, 0.7, 81),
('LUX', 7.7, 6, 76, 25, 0.3, 94),
('GBR', 7.3, 7, 120, 18, 1.2, 66),
('DEU', 5.6, 8, 47, 30, 1.0, 73),
('BEN', 4.7, 9, 2, 75, 1.1, 67),
('ECU', 4.7, 10, 457, 5, 5.8, 30),
('CMR', 3.5, 11, 18, 51, 1.4, 58),
('CYP', 3.1, 12, 10, 63, 0.6, 85),
('BHS', 2.9, 13, 166, 12, 30.9, 6),
('PRT', 2.8, 14, 115, 19, 0.7, 82),
('MAR', 2.1, 15, 135, 16, 2.1, 49),
('NLD', 2.1, 16, 47, 31, 0.8, 78),
('AUS', 2.0, 17, 39, 37, 0.8, 77),
('SAU', 1.8, 18, 9, 65, 1.3, 62),
('SVK', 1.7, 19, 9, 66, 1.5, 57),
('CHL', 1.6, 20, 633, 3, 4.3, 37),
('IRL', 1.6, 21, 45, 33, 0.9, 75),
('ROU', 1.6, 22, 16, 54, 1.5, 56),
('BGR', 1.4, 23, 22, 44, 1.5, 54),
('ARM', 1.2, 24, 8, 67, 2.4, 42),
('UKR', 1.2, 25, 47, 32, 6.2, 29),
('URY', 1.1, 26, 522, 4, 8.2, 25),
('MEX', 1.0, 27, 179, 10, 24.8, 12),
('PAN', 0.9, 28, 243, 8, 9.7, 20),
('PRI', 0.9, 29, 86, 21, 18.5, 13),
('GRC', 0.7, 30, 40, 35, 0.7, 80),
('ARE', 0.7, 31, 16, 55, 0.5, 91),
('PER', 0.6, 32, 223, 9, 7.7, 26),
('COL', 0.4, 33, 244, 7, 24.9, 11),
('JAM', 0.4, 34, 43, 34, 57.0, 2),
('KAZ', 0.4, 35, 52, 28, 5.0, 34),
('PRY', 0.4, 36, 29, 42, NULL, NULL),
('ITA', 0.3, 37, 51, 29, NULL, NULL),
('MKD', 0.3, 38, 20, 49, NULL, NULL),
('OMN', 0.3, 39, 1, 78, NULL, NULL),
('CRI', 0.2, 40, 1587, 1, 12.3, 15),
('CZE', 0.2, 41, 15, 56, 0.6, 86),
('HND', 0.2, 42, 121, 17, 41.7, 3),
('LVA', 0.2, 43, 31, 40, 4.2, 39),
('RUS', 0.2, 44, 6, 71, 9.2, 22),
('SRB', 0.2, 45, 26, 43, 1.1, 70),
('ALB', 0.1, 46, 6, 68, 2.3, 44),
('AZE', 0.1, 47, 4, 73, 2.0, 50),
('IDN', 0.1, 48, 4, 74, 0.4, 92),
('KOR', 0.1, 49, 2, 77, 0.6, 87),
('ESP', 0.1, 50, 143, 15, 0.7, 83),
('BMU', 0.0, 52, 83, 23, 8.2, 24),
('BTN', 0.0, 53, 2, 76, 1.6, 53),
('BIH', 0.0, 54, 20, 48, 1.2, 63),
('HRV', 0.0, 55, 21, 45, 1.1, 68),
('EST', 0.0, 56, 15, 57, 2.2, 47),
('FIN', 0.0, 57, 30, 41, 1.2, 65),
('GRD', 0.0, 58, 52, 27, 11.1, 17),
('GUY', 0.0, 59, 160, 13, 14.8, 14),
('HUN', 0.0, 60, 9, 64, 2.5, 41),
('LTU', 0.0, 61, 38, 38, 4.5, 36),
('MAC', 0.0, 62, 17, 52, 0.3, 95),
('MNE', 0.0, 63, 19, 50, 2.4, 43),
('SVN', 0.0, 64, 11, 62, 0.9, 76),
('CHE', 0.0, 65, 21, 47, 0.5, 90);
COMMIT;
...
CREATE TABLE Clients (
    ...
    BudgetLevel ENUM('Low', 'Medium', 'High') NOT NULL,
    PreferredLanguage VARCHAR(50) NOT NULL,
    DietPreference ENUM('None', 'Vegetarian', 'Vegan', 'Pescatarian') NOT NULL
);

START TRANSACTION;
INSERT INTO Clients (ClientID, CountryCode, Name, HasChildren, BudgetLevel, PreferredLanguage, DietPreference) VALUES
(1, 'USA', 'Alice Smith', TRUE, 'Medium', 'English', 'Vegetarian'),
(2, 'MEX', 'John Doe', FALSE, 'Low', 'Spanish', 'Pescatarian'),
(3, 'FRA', 'Maria Lopez', TRUE, 'High', 'French', 'Vegan'),
(4, 'CAN', 'William Brown', FALSE, 'High', 'English', 'None'),
(5, 'ARG', 'Sophia Johnson', TRUE, 'Medium', 'Spanish', 'Vegetarian'),
(6, 'DEU', 'Liam Wilson', TRUE, 'Low', 'German', 'None'),
(7, 'FRA', 'Olivia Davis', FALSE, 'Medium', 'French', 'Pescatarian'),
(8, 'ESP', 'Emma Garcia', TRUE, 'High', 'Spanish', 'Vegan'),
(9, 'USA', 'Noah Martinez', FALSE, 'Low', 'English', 'None'),
(10, 'FRA', 'Isabella Anderson', TRUE, 'Medium', 'French', 'Vegetarian'),
(11, 'AUS', 'James Taylor', FALSE, 'High', 'English', 'Pescatarian'),
(12, 'MEX', 'Charlotte Thomas', TRUE, 'Low', 'Spanish', 'Vegetarian'),
(13, 'KOR', 'Benjamin Lee', FALSE, 'Medium', 'Korean', 'None'),
(14, 'CAN', 'Amelia White', TRUE, 'High', 'French', 'Vegan'),
(15, 'USA', 'Mia Harris', FALSE, 'Low', 'English', 'Vegetarian'),
(16, 'DEU', 'Lucas Clark', TRUE, 'Medium', 'German', 'Pescatarian'),
(17, 'ESP', 'Ethan Lewis', FALSE, 'High', 'Spanish', 'None'),
(18, 'FRA', 'Harper Walker', TRUE, 'Low', 'French', 'None'),
(19, 'AUS', 'Ava Hall', FALSE, 'Medium', 'English', 'Vegetarian'),
(20, 'ARG', 'Logan Young', TRUE, 'High', 'Spanish', 'Pescatarian'),
(21, 'USA', 'Elijah Hernandez', FALSE, 'Low', 'English', 'Vegan'),
(22, 'CAN', 'Abigail King', TRUE, 'Medium', 'French', 'None'),
(23, 'MEX', 'Alexander Scott', FALSE, 'High', 'Spanish', 'Vegetarian'),
(24, 'DEU', 'Sofia Green', TRUE, 'Low', 'German', 'Pescatarian'),
(25, 'FRA', 'Jackson Adams', FALSE, 'Medium', 'French', 'None'),
(26, 'USA', 'Scarlett Hill', TRUE, 'High', 'English', 'Vegan'),
(27, 'ARG', 'Henry Phillips', FALSE, 'Low', 'Spanish', 'Vegetarian'),
(28, 'CAN', 'Grace Parker', TRUE, 'Medium', 'French', 'Pescatarian'),
(29, 'AUS', 'Oliver Evans', FALSE, 'High', 'English', 'None'),
(30, 'ESP', 'Chloe Turner', TRUE, 'Low', 'Spanish', 'Vegan');
COMMIT;

SELECT * FROM City;
SELECT * FROM CountryLanguage;
SELECT * FROM Country;
SELECT * FROM CountryPrices;
SELECT * FROM CountryCrime;
SELECT * FROM Clients;

-- 20 Queries
-- Joins (5 Queries)

-- ✅ Find all cities with a population greater than 1 million and their country names:
SELECT City.Name AS CityName, Country.Name AS CountryName, City.Population
FROM City
JOIN Country ON City.CountryCode = Country.Code
WHERE City.Population > 1000000;
-- Purpose: Helps identify large metropolitan areas by population for potential tourist destinations.

-- ✅ List the official languages spoken in each country along with their percentage:
...
-- ✅ Find countries with affordable fruit prices for vegetarian clients:
...
-- ✅ List cities in countries with a high milk, cheese, and eggs price index:
...
-- ✅ Show the country, city, and primary language for families traveling with children:
...
-- ✅ Find countries where the population is above the average global population:
SELECT Name, Population
FROM Country
WHERE Population > (SELECT AVG(Population) FROM Country);
-- Purpose: Identifies populous countries that might have extensive tourist attractions.

-- ✅ Find the official languages spoken in countries with a population under 1 million:
...
-- ✅ Match clients with a country that officially speaks their preferred language:
...
-- ✅ Get cities in countries with GNP higher than the global average:
...
-- ✅ Find clients interested in vegetarian or vegan diets:
...
-- ✅ Find countries with a low homicide rate and high life expectancy:
SELECT Name
FROM Country
WHERE Code IN (SELECT CountryCode FROM CountryCrime WHERE HomicideRate < 5) AND LifeExpectancy > 75;
-- Purpose: Recommends safe and healthy travel destinations.

-- ✅ Find countries in Europe with affordable fish prices:
SELECT Name
FROM Country
WHERE Code IN (SELECT CountryCode FROM CountryPrices WHERE FishSeafoodPrice < 100) AND Continent = 'Europe';
-- Purpose: Suggests European destinations for pescatarian clients on a budget.

-- Additional Queries (5 Queries)

-- ✅ List top 5 countries by population:
SELECT Name, Population
FROM Country
